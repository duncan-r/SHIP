...
class InterpolateUnit(AUnit):
    ...
    def __init__(self):
        ...
        self.head_data = {
            ...
            'distance': HeadDataItem(0.000, '{:<10}', 2, 0, dtype=dt.FLOAT, dps=3),
            'easting': HeadDataItem(0.000, '{:<10}', 2, 1, dtype=dt.FLOAT, dps=3),
            'northing': HeadDataItem(0.000, '{:<10}', 2, 2, dtype=dt.FLOAT, dps=3),
        }

...
class RiverUnitTests(unittest.TestCase):
    ...
    def test_readRowData(self):
        ...
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.CHAINAGE), self.chainage)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.ELEVATION), self.elevation)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.ROUGHNESS), self.roughness)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.PANEL_MARKER), self.panelmarker)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.RPL), self.rpl)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.BANKMARKER), self.bankmarker)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.EASTING), self.easting)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.NORTHING), self.northing)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.DEACTIVATION), self.deactivation)
        self.assertListEqual(river.row_data['main'].dataObjAsList(rdt.SPECIAL), self.special)
